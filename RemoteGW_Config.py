...
for REMOTE_SITES in (GDAGW, GIFGW, GKEGW, GKFGW, GKGGW, GIEGW, GIFGW,):
    net_connect = Netmiko(**REMOTE_SITES)
    net_connect.enable()
    output = net_connect.send_config_from_file('vlan1000.txt')
print(output)
print("Remote Site - GDA Update Complete")
print("Remote Site - GIF Update Complete")
print("Remote Site - GKE Update Complete")
print("Remote Site - GKF Update Complete")
print("Remote Site - GKG Update Complete")
print("Remote Site - GIE Update Complete")
print("Remote Site - GIF Update Complete")
